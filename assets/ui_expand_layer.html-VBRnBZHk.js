import{_ as n,o as a,c as s,e}from"./app-AFohO_fy.js";const t="/assets/image-20240415021735585-WgbbilsR.png",p={},i=e('<h2 id="预览overview" tabindex="-1"><a class="header-anchor" href="#预览overview" aria-hidden="true">#</a> 预览OVERVIEW</h2><p><img src="'+t+`" alt="image-20240415021735585"></p><h2 id="基础用法" tabindex="-1"><a class="header-anchor" href="#基础用法" aria-hidden="true">#</a> 基础用法</h2><h3 id="通过databinding创建" tabindex="-1"><a class="header-anchor" href="#通过databinding创建" aria-hidden="true">#</a> 通过DataBinding创建</h3><div class="language-kotlin line-numbers-mode" data-ext="kt"><pre class="language-kotlin"><code><span class="token comment">/**
 * DataBinding E.G
 */</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token operator">..</span><span class="token punctuation">.</span>
                ...
                <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,18),o=[i];function l(c,u){return a(),s("div",null,o)}const r=n(p,[["render",l],["__file","ui_expand_layer.html.vue"]]);export{r as default};
