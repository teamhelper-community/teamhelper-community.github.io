import{_ as n,o as a,c as s,e}from"./app-AFohO_fy.js";const t={},i=e(`<h2 id="获取实时相片帧" tabindex="-1"><a class="header-anchor" href="#获取实时相片帧" aria-hidden="true">#</a> 获取实时相片帧</h2><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
 * OCR SCAN RTC使用
 *
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),p=[i];function o(c,l){return a(),s("div",null,p)}const r=n(t,[["render",o],["__file","camera_capture_frame.html.vue"]]);export{r as default};
